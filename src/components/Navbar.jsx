...
import RotatingText from "../font/RotatingText";
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-30">
      <div className="bg-black/70 backdrop-blur-md fixed justify-around items-center py-3  text-white w-full z-10 hidden md:flex">
        <div>
          <a className="flex justify-center items-center gap-1" href="#">
            <p className="uppercase">Connect</p>
            <RotatingText
              texts={["dance", "group"]}
              mainClassName=" bg-transparent uppercase text-blue-400 overflow-hidden justify-center rounded-lg"
              staggerFrom={"last"}
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "-120%" }}
